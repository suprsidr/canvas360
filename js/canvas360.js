 ...
 *
 * Creates a 360 view using an array of images in a canvas element.
 */
...
function canvas360(params) {
  ...
  /**
   *  bgGradientColor1 is the outermost color for the background gradient
   */
  params.bgGradientColor1 = params.bgGradientColor1 || '#666666';
  /**
   *  bgGradientColor2 is the innermost color for the background gradient
   *  is set to true.
   */
  params.bgGradientColor2 = params.bgGradientColor2 || '#cccccc';
  /**
   *  Transparent background and ignore background color/gradient settings.
   */
  ...
  startPreload = function() {
    ...
    imageLogo.onload = function() {
      ...
      gradient.addColorStop(0, params.bgGradientColor1);
      gradient.addColorStop(1, params.bgGradientColor2);
      context.save();
